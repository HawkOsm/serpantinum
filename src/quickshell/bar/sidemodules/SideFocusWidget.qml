...
Rectangle {
    ...
    onMarqueeAllowedChanged: {
        ...
        if (marqueeAllowed && titleTextMain.implicitWidth > titleClipRect.height) titleAnim.restart();
        else titleAnim.stop();
    }
            ...
            Item {
                ...
                Item {
                    ...
                    Row {
                        ...
                        Text {
                            ...
                            onTextChanged: {
                                titleAnim.stop();
                                marqueeContainer.x = 0;
                                if (sideFocusRoot.marqueeAllowed && titleTextMain.implicitWidth > titleClipRect.height) {
                                    titleAnim.start();
                                }
                            }
                        }
                    ...
                    SequentialAnimation {
                        ...
                        running: sideFocusRoot.marqueeAllowed && titleTextMain.implicitWidth > titleClipRect.height
